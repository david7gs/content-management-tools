...
export default function LocaleList() {
  ...
  console.log(`compareLocales = ${compareLocales.test}`);
  ...
  function getCompare() {
    const fieldOne = [...data.firstStringArr];
    const fieldTwo = [...data.secondStringArr];
    ...
    const obj = {
      firstArr: [data.firstStringArr],
      secondArr: [data.secondStringArr],
    };
    handleSetCompareLocales(obj);
  }
